...
export interface RolePermissions {
  manageRoles:boolean; manageUsers:boolean; canViewUserUpdates:boolean;
  managePosts:boolean; manageMerchandise:boolean; manageRequests:boolean;
  manageApplications:boolean; printPermissionSlips:boolean; viewAdminDashboard:boolean;
  manageSettings:boolean; managePaymentGateways:boolean;
}
...
export const DEFAULT_PERMISSIONS: Record<string,RolePermissions> = {
  super_admin:{manageRoles:true,manageUsers:true,canViewUserUpdates:true,managePosts:true,manageMerchandise:true,manageRequests:true,manageApplications:true,printPermissionSlips:true,viewAdminDashboard:true,manageSettings:true,managePaymentGateways:true},
  admin:{manageRoles:true,manageUsers:true,canViewUserUpdates:true,managePosts:true,manageMerchandise:true,manageRequests:true,manageApplications:true,printPermissionSlips:true,viewAdminDashboard:true,manageSettings:true,managePaymentGateways:false},
  staff:{manageRoles:false,manageUsers:true,canViewUserUpdates:true,managePosts:true,manageMerchandise:true,manageRequests:true,manageApplications:true,printPermissionSlips:true,viewAdminDashboard:true,manageSettings:false,managePaymentGateways:false},
...
export interface UserProfile {
  ...
  cadetMiddleInitial?:string; cadetSchool?:string; division?:string;
  avatarUrl?:string; createdAt:any; updatedAt?:any;
}
export interface Post {
  ...
  isPrintable?:boolean; allowedRoles?:Role[]; likes?:number; createdAt:any; createdBy?:string;
}
...
export interface CartItem { id:string; name:string; price:string; quantity:number; selectedSize?:string; selectedColor?:string; image?:string; }
export interface Application {
  ...
  createdAt:any; notes?:string; reviewedBy?:string;
}
...
export interface MerchRequest {
  ...
  refundRequested?:boolean; requestId?:string; createdAt:any;
}
